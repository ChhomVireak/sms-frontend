...
class Nfsv4TcpClient {
    ...
    async compound(requestOrOps, tag = '', minorversion = 0) {
        ...
        const encoded = this.nfsEncoder.encodeCall(xid, 1 /* Nfsv4Proc.COMPOUND */, cred, verf, request);
        return new Promise((resolve, reject) => {
    ...
    async null() {
        ...
        rpcEncoder.writeCall(xid, 100003 /* Nfsv4Const.PROGRAM */, 4 /* Nfsv4Const.VERSION */, 0 /* Nfsv4Proc.NULL */, cred, verf);
